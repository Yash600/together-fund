"""
Thin Groq wrapper shared by every stage of the pipeline. Centralizes:
  - client construction (reads GROQ_API_KEY)
  - JSON-mode structured calls with Pydantic validation + one retry on a
    malformed response (LLMs occasionally wrap JSON in prose or code fences)
"""
import json
import os
import re
